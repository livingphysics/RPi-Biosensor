...
with open('data/251011_naive_galhis_ExP_ON_csm-his-leu-glu.csv', 'w', newline='') as csvfile, tqdm(total=duration, desc="Processing: ") as pbar, Bioreactor() as bioreactor:
